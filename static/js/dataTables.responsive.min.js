...
(function (n, p) {
    var o = function (e, k) {
        ...
        h.prototype = {_constructor: function () {
            ...
            c.each(function (b, d) {
                for (var c = b.className.split(" "), j = !1, h = 0, k = c.length; h < k; h++) {
                    ...
                    e.each(a, function (a, b) {
                        var c = b.name.split("-"), e = l.match(RegExp("(min\\-|max\\-|not\\-)?(" + c[0] + ")(\\-[_a-zA-Z0-9])?"));
            ...
            _detailsVis: function () {
                ...
                if (this.c.auto && -1 !== e.inArray(!0, e.map(a, function (a) {
                    ...
                    c = e("<div/>").css({width: 1, height: 1, overflow: "hidden"}).append(c).insertBefore(d.table().node());
        ...
        h.defaults = {breakpoints: h.breakpoints, auto: !0, details: {renderer: function (d, a) {
            var c = d.cells(a, ":hidden").eq(0).map(function (a) {
                var c =
                    e(d.column(a.column).header()), a = d.cell(a).index();
