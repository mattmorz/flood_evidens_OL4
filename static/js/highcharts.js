...
(function () {
    ...
    function H(a, b, c) {
        var d, e;
        if (Da(b))q(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (q(b) && ca(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function I(a, b) {
        if (xa && !ba && b && b.opacity !== u)b.filter = "alpha(opacity=" + b.opacity * 100 + ")";
        r(a.style, b)
    }
    ...
    function Y(a, b, c, d, e) {
        a = C.createElement(a);
        b && r(a, b);
        e && I(a, {padding: 0, border: L, margin: 0});
        c && I(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function Cb() {
        ...
        gb = function (a, c, d, h, i, j) {
            var k;
            b ? (k = za.UTC.apply(0, arguments), k +=
                Wa(k)) : k = (new za(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0))).getTime();
            return k
        };
        qb = c + "Minutes";
        rb = c + "Hours";
    ...
    var u, C = document, K = window, V = Math, x = V.round, U = V.floor, sa = V.ceil, s = V.max, J = V.min, P = V.abs, W = V.cos, Z = V.sin, la = V.PI, ga = la * 2 / 360, ma = navigator.userAgent, Gb = K.opera, xa = /(msie|trident)/i.test(ma) && !Gb, hb = C.documentMode === 8, wb = /AppleWebKit/.test(ma), Ua = /Firefox/.test(ma), Hb = /(Mobile|Android|Windows Phone)/.test(ma), Aa =
        "http://www.w3.org/2000/svg", ba = !!C.createElementNS && !!C.createElementNS(Aa, "svg").createSVGRect, Lb = Ua && parseInt(ma.split("Firefox/")[1], 10) < 4, ea = !ba && !xa && !!C.createElement("canvas").getContext, $a, ab, Ib = {}, xb = 0, fb, S, Oa, ya, yb, F, na = function () {
        return u
    ...
    Oa = function (a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"), d = new za(b - Wa(b)), e, f = d[rb](), g = d[sb](), h = d[Xa](), i = d[Ya](), j = d[Za](), k = S.lang, m = k.weekdays, d = r({a: m[g].substr(0, 3), A: m[g],
            d: Ia(h), e: h, w: g, b: k.shortMonths[i], B: k.months[i], m: Ia(i + 1), y: j.toString().substr(2, 2), Y: j, H: Ia(f), I: Ia(f % 12 || 12), l: f % 12 || 12, M: Ia(d[qb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Ia(d.getSeconds()), L: Ia(x(b % 1E3), 3)}, y.dateFormats);
    ...
    y.numberFormat = function (a, b, c, d) {
        var e = S.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] || "").length : isNaN(b = P(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(B(a = P(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
        ...
        K.HighchartsAdapter = K.HighchartsAdapter || a && {init: function (b) {
            ...
            a.fn.highcharts = function () {
                ...
                if (this[0]) {
                    ...
                    c = b[0];
                    if (c !== u)c.chart = c.chart || {}, c.chart.renderTo = this[0], new y[a](c, b[1]), g = this;
    ...
    var Q = K.HighchartsAdapter, A = Q || {};
    Q && Q.init.call(Q, yb);
    var jb = A.adapterRun, Ob = A.getScript, La = A.inArray, l = y.each = A.each,
        zb = A.grep, Pb = A.offset, Ma = A.map, O = A.addEvent, X = A.removeEvent, G = A.fireEvent, Qb = A.washMouseEvent, kb = A.animate, db = A.stop;
    ...
    var Rb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, Sb = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/,
        Tb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, oa = function (a) {
            ...
            return{get: function (c) {
                var f;
                d ? (f = z(a), f.stops = [].concat(f.stops), l(d, function (a, b) {
    ...
    M.prototype = {opacity: 1, textProps: "fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow".split(","), init: function (a, b) {
        ...
        animate: function (a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !q(g.gradientUnits) && (g = z(g, {cx: n[0] - n[2] / 2 + g.cx * n[2], cy: n[1] -
                    n[2] / 2 + g.cy * n[2], r: g.r * n[2], gradientUnits: "userSpaceOnUse"}));
                for (o in g)o !== "id" && t.push(o, g[o]);
                for (o in j)t.push(j[o]);
                t = t.join(",");
                h[t] ? a = h[t].attr("id") : (g.id = a = "highcharts-" + xb++, h[t] = i = d.createElement(f).attr(g).add(d.defs), i.stops = [], l(j, function (a) {
                    a[1].indexOf("rgba") === 0 ? (e = oa(a[1]), k = e.get("rgb"), m = e.get("a")) : (k = a[1], m = 1);
            ...
            var b =
                this.element, c, d = a.indexOf("contrast") !== -1, e = ma.indexOf("Safari") > 0 && ma.indexOf("Chrome") === -1, e = b.style.textShadow !== u && !xa && !e;
            d && (a = a.replace(/contrast/g, this.renderer.getContrast(b.style.fill)));
            e ? d && I(b, {textShadow: a}) : (this.ySetter = this.xSetter, c = [].slice.call(b.getElementsByTagName("tspan")), l(a.split(/\s?,\s?/g), function (a) {
                ...
                (i = a[a.length - 2]) && l(c, function (a, c) {
                    ...
                    f = a.cloneNode(1);
                    H(f, {stroke: e, "stroke-opacity": 1 / s(B(i), 3), "stroke-width": i, "stroke-linejoin": "round"});
                    b.insertBefore(f, d)
                })
            }))
        }, attr: function (a, b) {
            ...
            if (e) {
                ...
                if (xa && !ba)I(this.element, a); else {
                    b = function (a, b) {
                        return"-" +
                            b.toLowerCase()
                    };
            ...
            g = (c.y || 0) + (a.y || 0);
            if (d === "right" ||
                d === "center")f += (c.width - (a.width || 0)) / {right: 1, center: 2}[d];
            ...
            h !== u && (i = ["", e || 0, f && f.fontSize, d.style.width].join(","), i = h === "" || Mb.test(h) ? "num:" + h.toString().length +
                i : h + i);
            i && !a && (b = c.cache[i]);
            if (!b) {
                if (d.namespaceURI === Aa || c.forExport) {
                    try {
                        b = d.getBBox ? r({}, d.getBBox()) : {width: d.offsetWidth, height: d.offsetHeight}
                    } catch (j) {
                    }
                ...
                if (c.isSVG) {
                    a = b.width;
                    d = b.height;
                    if (xa && f && f.fontSize === "11px" && d.toPrecision(3) === "16.9")b.height = d = 14;
                    if (e)b.width = P(d * Z(g)) + P(a * W(g)), b.height = P(d * W(g)) + P(a * Z(g))
                }
                c.cache[i] = b
            }
            return b
            ...
            for (c && l(c, function (b) {
                a.safeRemoveChild(b)
            }); d && d.div && d.div.childNodes.length ===
                0;)b = d.parentGroup, a.safeRemoveChild(d.div), delete d.div, d = b;
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    H(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: L});
                    if (c)H(f, "height", s(H(f,
                        "height") - h, 0)), f.cutHeight = h;
        ...
        opacitySetter: function (a, b, c) {
            ...
            var c = this.renderer,
                d = this.parentGroup, c = (d || c).element || c.box, e, f, g = this.element, h, i;
            q(a) && (g.setAttribute(b, a), this[b] = +a);
            if (this.added) {
                if ((a = this.zIndex) && d)d.handleZ = !0;
                d = c.childNodes;
                for (i = 0; i < d.length && !h; i++)if (e = d[i], f = H(e, "zIndex"), e !== g && (B(f) > a || !q(a) && q(f)))c.insertBefore(g, e), h = !0;
                h || c.appendChild(g)
            }
            return h
    ...
    M.prototype.translateXSetter = M.prototype.translateYSetter = M.prototype.rotationSetter = M.prototype.verticalAlignSetter =
        M.prototype.scaleXSetter = M.prototype.scaleYSetter = function (a, b) {
            this[b] = a;
            this.doTransform = !0
        };
    ...
    ta.prototype = {Element: M, init: function (a, b, c, d, e) {
        ...
        if (Ua && a.getBoundingClientRect)this.subPixelFix = b = function () {
            ...
            I(a, {left: sa(h.left) - h.left + "px", top: sa(h.top) - h.top + "px"})
        }, b(), O(K, "resize", b)
    }, getStyle: function (a) {
        ...
        destroy: function () {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = H(b, "x"), k = a.styles, m = a.textWidth,
                     n = k && k.lineHeight, o = k && k.textShadow, t = k && k.textOverflow === "ellipsis", w = g.length, T = m && !a.added && this.box, D = function (a) {
                    return n ? B(n) : c.fontMetrics(/(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : k && k.fontSize || c.style.fontSize || 12, a).h
                }, v = function (a) {
                    return a.replace(/&lt;/g, "<").replace(/&gt;/g, ">")
                }; w--;)b.removeChild(g[w]);
            !f && !o && !t && e.indexOf(" ") === -1 ? b.appendChild(C.createTextNode(v(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, T && T.appendChild(b), e = f ? e.replace(/<(b|strong)>/g,
                ...
                l(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        h.test(e) && (p = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), H(w, "style", p));
                        i.test(e) && !d &&
                        (H(w, "onclick", 'location.href="' + e.match(i)[1] + '"'), I(w, {cursor: "pointer"}));
                        e = v(e.replace(/<(.|\n)*?>/g, "") || " ");
                        if (e !== " ") {
                            ...
                            H(w, o);
                            b.appendChild(w);
                            !n && f && (!ba && d && I(w, {display: "block"}), H(w, "dy", D(w)));
                            if (m) {
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, m, n, o, t, w, p, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = z({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [
                [0, "#FEFEFE"],
                [1, "#F6F6F6"]
            ]}, r: 2, padding: 5, style: {color: "black"}}, e);
            o = e.style;
            delete e.style;
            f = z(e, {stroke: "#68A", fill: {linearGradient: a,
                stops: [
                    [0, "#FFF"],
                    [1, "#ACF"]
                ]}}, f);
            ...
            O(j.element, xa ? "mouseout" : "mouseleave", function () {
                k !== 3 && (m = [e, f, g][k], n = [o, t, w][k], j.attr(m).css(n))
            });
        ...
        arc: function (a, b, c, d, e, f) {
            ...
            var e = ca(a) ? a.r : e, g = this.createElement("rect"), a = ca(a) ? a : a === u ? {} : {x: a, y: b, width: s(c, 0), height: s(d, 0)};
            ...
            var g,
                h = this.symbols[a], h = h && h(x(b), x(c), d, e, f), i = /^url\((.*?)\)$/, j, k;
            ...
            }, j = a.match(i)[1], a = Ib[j] || f && f.width && f.height && [f.width, f.height], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0, height: 0}), Y("img", {onload: function () {
            ...
            var f = e.start, c = e.r || c || d, g = e.end - 0.001,
                d = e.innerR, h = e.open, i = W(f), j = Z(f), k = W(g), g = Z(g), e = e.end - f < la ? 0 : 1;
            return["M", a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? "M" : "L", a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z"]
        }, callout: function (a, b, c, d, e) {
            var f = J(e && e.r || 0, c, d), g = f + 6, h = e && e.anchorX, i = e && e.anchorY, e = x(e.strokeWidth || 0) % 2 / 2;
            a += e;
            b += e;
            ...
            h && h > c && i > b + g && i < b + d - g ? e.splice(13, 3, "L", a + c, i -
                6, a + c + 6, i, a + c, i + 6, a + c, b + d - f) : h && h < 0 && i > b + g && i < b + d - g ? e.splice(33, 3, "L", a, i + 6, a - 6, i, a, i - 6, a, b + f) : i && i > d && h > a + g && h < a + c - g ? e.splice(23, 3, "L", h + 6, b + d, h, b + d + 6, h - 6, b + d, a + f, b + d) : i && i < 0 && h > a + g && h < a + c - g && e.splice(3, 3, "L", h - 6, b, h, b - 6, h + 6, b, c - f, b);
            return e
            ...
            var a = /px/.test(a) ? B(a) : /em/.test(a) ?
                parseFloat(a) * 12 : 12, c = a < 24 ? a + 3 : x(a * 1.2), d = x(c * 0.8);
            return{h: c, b: d, f: a}
            ...
            function j() {
                ...
                if (A) {
                    if (!w)a = x(-D * v), b = h ? -J : 0, o.box = w = d ? n.symbol(d, a, b, o.width, o.height, E) : n.rect(a, b, o.width, o.height,
                        0, E[Nb]), w.attr("fill", L).add(o);
                    w.isImg || w.attr(r({width: x(o.width), height: x(o.height)}, E));
                    E = null
                }
            }
            ...
            function k() {
                ...
                c = h ? 0 : J;
                if (q(fa) && p && (a === "center" || a === "right"))b += {center: 0.5, right: 1}[a] * (fa - p.width);
                if (b !== t.x || c !== t.y)t.attr("x", b), c !== u && t.attr("y", c);
                t.x = b;
                t.y = c
            }
            ...
            var n = this, o = n.g(i), t = n.text("", 0, 0, g).attr({zIndex: 1}), w, p, D = 0, v = 3, Ba = 0, fa, s, y, C, B = 0, E = {}, J, A;
            o.onAdd = function () {
                t.add(o);
                o.attr({text: a || a === 0 ? a :
                    "", x: b, y: c});
    ...
    $a = ta;
    r(M.prototype, {htmlCss: function (a) {
        var b = this.element;
        ...
        if (this.added) {
            ...
            if (b.tagName === "SPAN") {
                var k = this.rotation,
                    m, n = B(this.textWidth), o = [k, g, b.innerHTML, this.textWidth].join(",");
                if (o !== this.cTT) {
                    m = a.fontMetrics(b.style.fontSize).b;
                    q(k) && this.setSpanRotation(k, h, m);
                    i = p(this.elemWidth, b.offsetWidth);
                    if (i > n && /[ \-]/.test(b.textContent || b.innerText))I(b, {width: n + "px", display: "block", whiteSpace: j && j.whiteSpace || "normal"}), i = n;
                    this.getSpanCorrection(i, m, h, k, g)
                }
                I(b, {left: e + (this.xCorr || 0) + "px", top: f + (this.yCorr || 0) + "px"});
                if (wb)m = b.offsetHeight;
                this.cTT = o
            }
            ...
            if (this.parentGroup = a) {
                if (b = a.div, !b) {
                    ...
                    l(j.reverse(), function (a) {
                        var d;
                        b = a.div = a.div || Y(Ka, {className: H(a.element, "class")}, {position: "absolute", left: (a.translateX || 0) + "px",
                            top: (a.translateY || 0) + "px"}, b || c);
                        d = b.style;
    ...
    if (!ba && !ea) {
        A = {init: function (a, b) {
            ...
            var a =
                this.rotation, b = W(a * ga), c = Z(a * ga);
            I(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c, ", M22=", b, ", sizingMethod='auto expand')"].join("") : L})
            ...
            for (var b = a.length, c = []; b--;)if (qa(a[b]))c[b] = x(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
            return c.join(" ") || "x"
        }, clip: function (a) {
            var b = this, c;
            ...
            safeRemoveChild: function (a) {
                ...
                var d = c.nodeName;
                if (d === "SPAN")c.style.color = a; else if (d !== "IMG")c.filled = a !== L, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
        ...
        A.prototype.ySetter = A.prototype.widthSetter = A.prototype.heightSetter =
            A.prototype.xSetter;
        var Na = {Element: A, isIE8: ma.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
            ...
            if (i) {
                ...
                q[0] < 1 && a.push([1, q[1]]);
                l(a, function (a, b) {
                    g.test(a[1]) ? (f = oa(a[1]), k = f.get("rgb"), m = f.get("a")) : (k = a[1], m = 1);
                    fa.push(a[0] * 100 + "% " + k);
                    b ? (w = m, p = k) : (t = m, D = k)
                });
                if (c === "fill")if (i === "gradient")c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, o = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, v = 'angle="' + (90 - V.atan((n - a) / (o - c)) * 180 / la) + '"', u(); else {
                    var j = n.r, s = j * 2, x = j * 2, r = n.cx, E = n.cy, z = b.radialReference, y, j = function () {
                        z && (y =
                            d.getBBox(), r += (z[0] - y.x) / y.width - 0.5, E += (z[1] - y.y) / y.height - 0.5, s *= z[2] / y.width, x *= z[2] / y.height);
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = oa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], Y(this.prepVML(h), null, null, b), j = f.get("rgb"); else {
            ...
            var f = e.start, g = e.end, h = e.r || c || d, c = e.innerR, d = W(f), i = Z(f), j = W(g), k = Z(g);
            if (g - f === 0)return["x"];
    ...
    Ta.prototype = {addLabel: function () {
        ...
        var b = this.axis, c = a.x, d = b.chart.chartWidth, e = b.chart.spacing, f = p(b.labelLeft, e[3]), e = p(b.labelRight, d - e[1]), g = this.label,
            h = this.rotation, i = {left: 0, center: 0.5, right: 1}[b.labelAlign], j = g.getBBox().width, b = b.slotWidth, k;
        ...
        return{x: a ? e.translate(b + c, null, null, d) + e.transB : e.left + e.offset + (e.opposite ?
        ...
        var i = this.axis, j = i.transA, k = i.reversed, m = i.staggerLines, n = i.tickRotCorr || {x: 0, y: 0}, c = p(e.y, n.y + (i.side === 2 ? 8 : -(c.getBBox().height / 2))), a = a + e.x + n.x - (f && d ? f * j * (k ? -1 : 1) : 0), b = b + c - (f && !d ? f * j * (k ? 1 : -1) : 0);
        ...
        var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, m = this.gridLine, n = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick", t = e[n + "LineWidth"], w = e[n + "LineColor"], l = e[n + "LineDashStyle"], D = e[o + "Length"], n = e[o + "Width"] || 0, v = e[o + "Color"], q = e[o + "Position"], o = this.mark, fa = k.step, s = !0, x = d.tickmarkOffset, r = this.getPosition(g, j, x, b), y = r.x, r = r.y, z = g && y === d.pos + d.len || !g && r === d.pos ? -1 : 1, c = p(c, 1);
        this.isActive = !0;
        if (t) {
            j =
                d.getPlotLinePath(j + x, t * z, b, !0);
            if (m === u) {
                m = {stroke: w, "stroke-width": t};
                if (l)m.dashstyle = l;
                if (!h)m.zIndex = 1;
                if (b)m.opacity = 0;
        ...
        if (n && D)q === "inside" && (D = -D), d.opposite && (D = -D), h = this.getMarkPath(y, r, D, n * z, g, f), o ? o.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: v, "stroke-width": n, opacity: c}).add(d.axisGroup);
        if (i && !isNaN(y))i.xy = r = this.getLabelPosition(y, r, i, g, k, x, a, fa), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? s = !1 : g && !d.isRadial && !k.step && !k.rotation && !b && c !== 0 && this.handleOverflow(r), fa && a % fa && (s = !1), s && !isNaN(r.y) ? (r.opacity = c, i[this.isNew ? "attr" : "animate"](r), this.isNew = !1) : i.attr("y", -9999)
    }, destroy: function () {
        Qa(this, this.axis)
    }};
    ...
    y.PlotLineOrBand.prototype = {render: function () {
        var a = this, b = a.axis, c = b.horiz, d = a.options, e = d.label, f = a.label,
            g = d.width, h = d.to, i = d.from, j = q(i) && q(h), k = d.value, m = d.dashStyle, n = a.svgElem, o = [], t, w = d.color, p = d.zIndex, l = d.events, v = {}, s = b.chart.renderer;
        b.isLog && (i = Ea(i), h = Ea(h), k = Ea(k));
        if (g) {
            if (o = b.getPlotLinePath(k, g), v = {stroke: w, "stroke-width": g}, m)v.dashstyle = m
        } else if (j) {
        ...
        } else if (o && o.length && (a.svgElem = n = s.path(o).attr(v).add(), l))for (t in d = function (b) {
            n.on(b, function (c) {
                l[b].apply(a, [c])
            })
        }, l)d(t);
    ...
    ua.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#D8D8D8", labels: {enabled: !0, style: {color: "#606060",
        ...
        showLastLabel: !0, labels: {x: -8, y: 3}, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, tickWidth: 0, title: {rotation: 270, text: "Values"}, stackLabels: {enabled: !1, formatter: function () {
            return y.numberFormat(this.total, -1)
        }, style: aa.line.dataLabels.style}}, defaultLeftAxisOptions: {labels: {x: -15, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {x: 15, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {autoRotation: [-45], x: 0, y: null}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {autoRotation: [-45],
        x: 0, y: -15}, title: {rotation: 0}}, init: function (a, b) {
        var c = b.isX;
        ...
        La(this, a.axes) === -1 && (c && !this.isColorAxis ?
            a.axes.splice(a.xAxis.length, 0, this) : a.axes.push(this), a[this.coll].push(this));
        ...
        if (h)g = Ja(h, this); else if (c)g = b; else if (d)g = Oa(d, b); else if (f && a >= 1E3)for (; f-- && g === u;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = y.numberFormat(b / c, -1) + e[f]);
        ...
        l(a.series, function (c) {
            if (c.visible || !b.options.chart.ignoreHiddenSeries) {
                ...
                a.isLog && d <= 0 && (d = null);
                if (a.isXAxis) {
                    if (d = c.xData, d.length)a.dataMin = J(p(a.dataMin, d[0]), Pa(d)), a.dataMax = s(p(a.dataMax, d[0]), Fa(d))
                } else {
                    c.getExtremes();
                    e = c.dataMax;
                    c = c.dataMin;
                    if (q(c) && q(e))a.dataMin = J(p(a.dataMin, c), c), a.dataMax = s(p(a.dataMax, e), e);
                    if (q(d))if (a.dataMin >=
        ...
        var g = 1, h = 0, i = d ? this.oldTransA : this.transA, d = d ? this.oldMin : this.min, j = this.minPixelPadding, e = (this.postTranslate || this.isLog && e) && this.lin2val;
        if (!i)i = this.transA;
        if (c)g *= -1, h = this.len;
        this.reversed && (g *= -1, h -= g * (this.sector || this.len));
        b ? (a = a * g + h, a -= j, a = a / i + d, e && (a = this.lin2val(a))) : (e && (a = this.val2lin(a)), f === "between" && (f = 0.5), a = g * (a - d) * i + h + g * j + (qa(f) ? i * f * this.pointRange :
            0));
        return a
        ...
        var o = function (a, b, c) {
            if (a < b || a > c)d ? a = J(s(b, a), c) : n = !0;
            return a
        }, e = p(e, this.translate(a, null, null, c)), a = c = x(e + i);
        i = j = x(k - e - i);
        isNaN(e) ? n = !0 : this.horiz ?
            (i = h, j = k - this.bottom, a = c = o(a, g, g + this.width)) : (a = g, c = m - this.right, i = j = o(i, h, h + this.height));
        ...
        var a = this.options, b = this.tickPositions, c = this.minorTickInterval, d = [], e = this.min, f = this.max;
        if ((f - e) / c < this.len / 3)if (this.isLog) {
            e = b.length;
            for (a =
        ...
        var a = this.options,
            b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, j;
        if (this.isXAxis && this.minRange === u && !this.isLog)q(a.min) || q(a.max) ? this.minRange = null : (l(this.series, function (a) {
            i = a.xData;
        ...
        if (b.isXAxis || i || d)h ? (f = h.minPointOffset, g = h.pointRangePadding) : l(b.series, function (a) {
            var h = i ? 1 : b.isXAxis ? a.pointRange : b.axisPointRange || 0, j = a.options.pointPlacement, o = a.closestPointRange;
            h > c && (h = 0);
            d = s(d, h);
            b.single || (f = s(f, Da(j) ? 0 : h / 2), g = s(g, j === "on" ? 0 : h));
            !a.noSharedTooltip && q(o) && (e = q(e) ? J(e, o) : o)
        }), h = b.ordinalSlope &&
            e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = J(d, c), b.closestPointRange = e;
        if (a)b.oldTransA = j;
        b.translationSlope = b.transA = j = b.len / (c + g || 1);
        b.transB = b.horiz ? b.left : b.bottom;
        b.minPixelPadding = j * f
    }, setTickInterval: function (a) {
        var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = d.maxPadding, j = d.minPadding, k = d.tickInterval, m = d.tickPixelInterval, n = b.categories;
        !f && !n && !h && this.getTickAmount();
        h ? (b.linkedParent = c[b.coll][d.linkedTo],
            c = b.linkedParent.getExtremes(), b.min = p(c.min, c.dataMin), b.max = p(c.max, c.dataMax), d.type !== b.linkedParent.options.type && ka(11, 1)) : (b.min = p(b.userMin, d.min, b.dataMin), b.max = p(b.userMax, d.max, b.dataMax));
        if (e)!a && J(b.min, p(b.dataMin, b.min)) <= 0 && ka(10, 1), b.min = da(Ea(b.min)), b.max = da(Ea(b.max));
        if (b.range && q(b.max))b.userMin = b.min = s(b.min, b.max - b.range), b.userMax = b.max, b.range = null;
        b.beforePadding && b.beforePadding();
        b.adjustForMinRange();
        if (!n && !b.axisPointRange && !b.usePercentage && !h && q(b.min) && q(b.max) &&
            (c = b.max - b.min)) {
        ...
        if (qa(d.ceiling))b.max = J(b.max, d.ceiling);
        ...
        if (!f && !e && !k)b.tickInterval = ob(b.tickInterval, null, nb(b.tickInterval), p(d.allowDecimals, !(b.tickInterval > 0.5 &&
            b.tickInterval < 5 && b.max > 1E3 && b.max < 9999)), !!this.tickAmount);
        ...
        this.tickPositions = b = a.tickPositions &&
            a.tickPositions.slice();
        ...
        this.allowZoomOutside || (q(c) && a <= J(c, p(e.min, c)) && (a = u), q(d) && b >= s(d, p(e.max, d)) && (b = u));
        ...
        var b = this.isLog, c = b ? ha(this.min) :
            this.min, b = b ? ha(this.max) : this.max;
        ...
        c ? (m = q(h) ? [h] : f < 80 && !b.staggerLines && !b.step && b.autoRotation) && l(m, function (a) {
            var b;
            a && a >= -90 && a <= 90 && (j = n(P(i.h / Z(ga * a))), b = j + P(a / 360), b < k && (k = b, g = a, e = j))
        }) : e = n(i.h);
        this.autoRotation = m;
        ...
        var a = this.chart, b = a.renderer, c = this.tickPositions, d = this.ticks, e = this.options.labels, f = this.horiz, g = a.margin, h = this.slotWidth = f && !e.step && !e.rotation && (this.staggerLines || 1) * a.plotWidth / c.length || !f && (g[3] && g[3] - a.spacing[3] || a.chartWidth *
            0.33), i = s(1, x(h - 2 * (e.padding || 5))), j = {}, g = b.fontMetrics(e.style.fontSize, d[0] && d[0].label), k, m = 0;
        ...
        j.rotation && (k = {width: (m > a.chartHeight * 0.5 ? a.chartHeight *
        ...
        var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, m = 0, n, o = 0, t = d.title, w = d.labels, T = 0, D = b.axisOffset,
            b = b.clipOffset, v = [-1, 1, 1, -1][h], r;
        a.hasData = j = a.hasVisibleSeries || q(a.min) && q(a.max) && !!e;
        a.showAxis = k = j || p(d.showEmpty, !0);
        a.staggerLines = a.horiz && w.staggerLines;
        if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: w.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add();
        if (j || a.isLinked) {
            if (l(e, function (b) {
                f[b] ? f[b].addLabel() : f[b] = new Ta(a, b)
            }), a.renderUnsquish(),
                l(e, function (b) {
                    if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === a.labelAlign)T = s(f[b].getLabelSize(), T)
                }), a.staggerLines)T *= a.staggerLines, a.labelOffset = T
        } else for (r in f)f[r].destroy(), delete f[r];
        if (t && t.text && t.enabled !== !1) {
            if (!a.axisTitle)a.axisTitle = c.text(t.text, 0, 0, t.useHTML).attr({zIndex: 7, rotation: t.rotation || 0, align: t.textAlign || {low: "left", middle: "center", high: "right"}[t.align]}).addClass("highcharts-" + this.coll.toLowerCase() + "-title").css(t.style).add(a.axisGroup), a.axisTitle.isNew = !0;
            if (k)m =
                a.axisTitle.getBBox()[g ? "height" : "width"], n = t.offset, o = q(n) ? 0 : p(t.margin, g ? 5 : 10);
        ...
        return{x: a ? d : b + (g ? this.width : 0) + h + (e.x || 0), y: a ?
        ...
        if (w || f) {
            ...
            n && l(g, function (b, c) {
                if (c % 2 === 0 && b < a.max)k[b] || (k[b] = new y.PlotLineOrBand(a)), v = b + o, r = g[c + 1] !== u ? g[c + 1] + o : a.max, k[b].options = {from: e ? ha(v) : v, to: e ? ha(r) : r, color: n}, k[b].render(), k[b].isActive = !0
            });
        ...
        if (t)w = a.getLinePath(t), a.axisLine ? a.axisLine.animate({d: w}) : a.axisLine = c.path(w).attr({stroke: d.lineColor,
            "stroke-width": t, zIndex: 7}).add(a.axisGroup), a.axisLine[D ? "show" : "hide"]();
        ...
        if (!this.crosshair || (q(b) || !p(this.crosshair.snap, !0)) === !1 || q(b) && p(this.crosshair.snap, !0) && (!b.series || b.series[this.isXAxis ? "xAxis" : "yAxis"] !== this))this.hideCrosshair(); else if (p(d.snap, !0) ? q(b) && (c = this.chart.inverted != this.horiz ? b.plotX : this.len - b.plotY) : c = this.horiz ?
            a.chartX - this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null)this.hideCrosshair(); else if (this.cross)this.cross.attr({visibility: "visible"})[e ? "animate" : "attr"]({d: c}, e); else {
    ...
    r(ua.prototype, {getPlotBandPath: function (a, b) {
    ...
    ua.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (q(b)) {
            ...
            b = 1;
            if (mb || eb)i = i.getTime(), i = new za(i + Wa(i));
            h = i[Za]();
            for (var d = i.getTime(), m = i[Ya](), n = i[Xa](), o = (F.day + (g ? Wa(i) : i.getTimezoneOffset() * 6E4)) % F.day; d < c;)e.push(d),
                j === F.year ? d = gb(h + b * k, 0) : j === F.month ? d = gb(h, m + b * k) : !g && (j === F.day || j === F.week) ? d = gb(h, m, n + b * k * (j === F.day ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            l(zb(e, function (a) {
    ...
    ua.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = x(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = U(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] :
            a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
            i = e.length;
            for (h = 0; h < i && !m; h++)j = Ea(ha(f) * e[h]), j > b && (!d || k <= c) && k !== u && g.push(k), k > c && (m = !0), k = j
        } else if (b = ha(b), c = ha(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ob(a, null, nb(a)), g = Ma(this.getLinearTickPositions(a, b, c), Ea), !d)this._minorAutoInterval = a / 5;
    ...
    Kb.prototype = {init: function (a, b) {
        ...
        if (!this.isHidden)c =
            ...
            b.label.fadeOut();
            b.isHidden = !0
        }, p(a, this.options.hideDelay, 500)), c && l(c, function (a) {
            a.setState()
        ...
        var d = this.chart, e = this.distance, f = {}, g, h = ["y", d.chartHeight, b, c.plotY + d.plotTop], i = ["x", d.chartWidth, a, c.plotX + d.plotLeft], j = p(c.ttBelow, d.inverted && !c.negative || !d.inverted && c.negative), k = function (a, b, c, d) {
            ...
            k.apply(0, h) !== !1 ? m.apply(0, i) === !1 && !g && (n(!0), o()) : g ? f.x = f.y = 0 : (n(!0), o())
        };
        ...
        refresh: function (a, b) {
            ...
            f = g[0];
            g = g[1];
            m && (!a.series || !a.series.noSharedTooltip) ? (c.hoverPoints = a, h && l(h, function (a) {
                a.setState()
            }), l(a, function (a) {
                a.setState("hover");
    ...
    Va.prototype = {init: function (a, b) {
        ...
        if (n && d && n !== g)if (e && !n.series.noSharedTooltip) {
            f = m.length;
            for (c = n.plotX + n.series.xAxis.left; f--;)h = m[f].plotX + m[f].series.xAxis.left, (m[f].x !== n.x || h !== c || !q(m[f].y) || m[f].series.noSharedTooltip) && m.splice(f, 1);
            d.refresh(m, a);
            l(m, function (b) {
                b.onMouseOver(a)
            })
        } else d.refresh(n, a), n.onMouseOver(a); else f = h && h.tooltipOptions.followPointer, d && f && !d.isHidden && (f = d.getAnchor([
            {}
        ],
        ...
        if (a)f.refresh(g), e && (e.setState(e.state, !0), l(c.axes, function (b) {
            p(b.options.crosshair && b.options.crosshair.snap, !0) ? b.drawCrosshair(null, a) : b.hideCrosshair()
        })); else {
            if (e)e.onMouseOut();
            if (d)d.onMouseOut();
            f && f.hide(b);
            if (this._onDocumentMouseMove)X(C, "mousemove",
        ...
        if (this.hasDragged > 10) {
            ...
            if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && m && !t && !this.selectionMarker)this.selectionMarker =
        ...
        if (this.selectionMarker) {
            ...
            if (this.hasDragged || d)l(c.axes, function (c) {
                if (c.zoomEnabled && q(c.min) && (d || b[{xAxis: "zoomX", yAxis: "zoomY"}[c.coll]])) {
                    var f = c.horiz, o = a.type === "touchend" ? c.minPixelPadding : 0, t = c.toValue((f ? g : h) + o), f = c.toValue((f ? g + i : h + j) - o);
                    e[c.coll].push({axis: c, min: J(t, f), max: s(t, f)});
                    k = !0
                }
        ...
        c && d && !this.inClass(a.target, "highcharts-tracker") && !b.isInsidePlot(a.chartX -
        ...
        a.cancelBubble = !0;
        b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (G(c.series, "click", r(a, {point: c})),
    ...
    r(y.Pointer.prototype, {pinchTranslate: function (a, b, c, d, e, f) {
        ...
        c();
        b = p;
        b < v.min ? (b = v.min, y = !0) : b + t > v.max && (b = v.max - t, y = !0);
        y ? (s -= 0.8 * (s - g[j][0]), q || (x -= 0.8 * (x - g[j][1])), c()) : g[j] = [s, x];
        D || (f[j] = p - o, f[n] = t);
        f = D ? 1 / l : l;
        e[n] = t;
        e[j] = b;
        ...
        }), g.x = [d[0].chartX, d[1] && d[1].chartX], g.y = [d[0].chartY, d[1] && d[1].chartY], l(c.axes,
            function (a) {
                if (a.zoomEnabled) {
                    var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(p(a.options.min, a.dataMin)), f = a.toPixels(p(a.options.max, a.dataMax)), g = J(e, f), e = s(e, f);
                    b.min = J(a.pos, g - d);
                    b.max = s(a.pos + a.len, e + d)
                }
            }), b.res = !0; else if (d.length) {
            if (!i)b.selectionMarker = i = r({destroy: na}, c.plotBox);
    ...
    if (K.PointerEvent || K.MSPointerEvent) {
        var va = {}, Ab = !!K.PointerEvent, Ub = function () {
            ...
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && $[Ca])d(a), d = $[Ca].pointer, d[b]({type: c, target: a.currentTarget, preventDefault: na, touches: Ub()})
        };
        ...
        cb(Va.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
            (this.hasZoom || this.followTouchMove) && I(b.container, {"-ms-touch-action": L, "touch-action": L})
        });
    ...
    lb.prototype = {init: function (a, b) {
        ...
        if (b.enabled)c.itemStyle =
            d, c.itemHiddenStyle = z(d, b.itemHiddenStyle), c.itemMarginTop = e, c.padding = d = p(b.padding, 8), c.initialItemX = d, c.initialItemY = d - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.symbolWidth = p(b.symbolWidth, 16), c.pages = [], c.render(), O(c.chart, "endResize", function () {
        ...
        if (b)c = b.translateY, l(this.allItems, function (e) {
            var f = e.checkbox, g;
            f && (g = c + f.y + (a || 0) + 3, I(f, {left: b.translateX + e.checkboxOffset + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : L}))
        })
        ...
        var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? p(d.itemDistance, 20) : 0, m = !d.rtl, n = d.width, o = d.itemMarginBottom || 0,
            t = this.itemMarginTop, w = this.initialItemX, l = a.legendItem, q = a.series && a.series.drawLegendSymbol ? a.series : a, v = q.options, v = this.createCheckboxForItem && v && v.showCheckbox, r = d.useHTML;
        if (!l) {
            a.legendGroup = c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup);
            a.legendItem = l = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), m ? f + g : -g, this.baseline || 0, r).css(z(a.visible ? h : i)).attr({align: m ? "left" : "right", zIndex: 2}).add(a.legendGroup);
            if (!this.baseline)this.baseline = c.fontMetrics(h.fontSize,
                l).f + 3 + t, l.attr("y", this.baseline);
        ...
        if (e && this.itemX - w + f > (n || b.chartWidth - 2 * j - w - d.x))this.itemX = w, this.itemY += t + this.lastLineHeight + o;
        this.maxItemWidth = s(this.maxItemWidth, f);
        this.lastItemY = t + this.itemY + o;
        this.lastLineHeight =
            s(g, this.lastLineHeight);
        a._legendItemPos = [this.itemX, this.itemY];
        e ? this.itemX += f : (this.itemY += t + g + o, this.lastLineHeight = g);
        this.offsetWidth = n || s((e ? this.itemX - w - k : f) + j, this.offsetWidth)
    }, getAllItems: function () {
        var a = [];
        l(this.chart.series, function (b) {
            var c = b.options;
            if (p(c.showInLegend, !q(c.linkedTo) ? u : !1, !0))a = a.concat(b.legendItems || (c.legendType === "point" ? b.data : b))
        });
        return a
        ...
        if (m || n) {
            if (i) {
                if (g > 0 && h > 0)i[i.isNew ? "attr" : "animate"](i.crisp({width: g,
                    height: h})), i.isNew = !1
            } else a.box = i = c.rect(0, 0, g, h, j.borderRadius, m || 0).attr({stroke: j.borderColor, "stroke-width": m || 0, fill: n || L}).add(d).shadow(j.shadow), i.isNew = !0;
            i[f ? "show" : "hide"]()
        }
        a.legendWidth = g;
        a.legendHeight = h;
        ...
        var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y, f = c.spacingBox.height + (e.verticalAlign === "top" ? -f : f) - this.padding, g =
            e.maxHeight, h, i = this.clipRect, j = e.navigation, k = p(j.animation, !0), m = j.arrowSize || 12, n = this.nav, o = this.pages, t, w = this.allItems;
    ...
    Na = y.LegendSymbolMixin = {drawRectangle: function (a, b) {
        ...
        d = a.symbolWidth;
        var e = this.chart.renderer, f = this.legendGroup, a = a.baseline - x(e.fontMetrics(a.options.itemStyle.fontSize,
    ...
    {callbacks: [], init: function (a, b) {
        ...
        var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length,
            m = k, n = this.renderer, o = n.isHidden(), t = [];
        Sa(a, this);
        ...
        i && (l(b, function (a) {
            ...
            function (a) {
                if (a.isDirtyExtremes)a.isDirtyExtremes = !1, t.push(function () {
        ...
        getContainer: function () {
            ...
            c = this.chartWidth;
            d = this.chartHeight;
            this.container = a = Y(Ka, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e},
        ...
        this.resetMargins();
        if (d && !q(c[0]))this.plotTop = s(this.plotTop,
        ...
        var b = this, c = b.options.chart, d = b.renderTo, e = c.width || jb(d, "width"), f = c.height ||
            jb(d, "height"), c = a ? a.target : K, d = function () {
        ...
        if (q(a))d.chartWidth = e = s(0, x(a)), d.hasUserSize = !!e;
        if (q(b))d.chartHeight = f = s(0, x(b));
        (ya ? kb : I)(d.container, {width: e + "px", height: f + "px"}, ya);
        d.setChartSize(!0);
        ...
        this.spacingBox = c.spacingBox = {x: g[3], y: g[0], width: d -
        ...
        if (k)f ? f.animate(v) : this.plotBackground = b.rect(t, p, l, q, 0).attr({fill: k}).add().shadow(a.plotShadow);
        if (m)h ? h.animate(v) : this.plotBGImage = b.image(m, t, p, l, q).add();
        r ? r.animate({width: s.width, height: s.height}) : this.clipRect = b.clipRect(s);
        if (n)g ? g.animate(g.crisp({x: t, y: p, width: l, height: q, strokeWidth: -n})) : this.plotBorder = b.rect(t, p, l, q, 0, -n).attr({stroke: a.plotBorderColor, "stroke-width": n,
            fill: L, zIndex: 1}).add();
        this.isDirtyBox = !1
        ...
        l("title,subtitle,chartBackground,plotBackground,plotBGImage,plotBorder,seriesGroup,clipRect,credits,pointer,scroller,rangeSelector,legend,resetZoomButton,tooltip,renderer".split(","),
            function (b) {
                var c = a[b];
                c && c.destroy && (a[b] = c.destroy())
            });
        if (d)d.innerHTML = "", X(d), f && Ra(d);
        for (e in a)delete a[e]
    ...
    Ga.prototype = {init: function (a, b, c) {
        ...
        if (typeof a === "number" || a === null)b[d[0]] =
            a; else if (Ha(a)) {
            if (a.length > e) {
                c = typeof a[0];
    ...
    {isCartesian: !0, type: "line", pointClass: Ga, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis", "yAxis"], colorCounter: 0, parallelArrays: ["x", "y"], init: function (a, b) {
        ...
        if (d === "month" || d === "year")a = new za(b), a = d === "month" ? +a[ub](a[Ya]() + c) : +a[vb](a[Za]() + c), c = a - b;
        this.xIncrement = b + c;
        return b
        ...
        if ((c.negativeColor || c.negativeFillColor) && !c.zones)a.push({value: c[this.zoneAxis + "Threshold"] || c.threshold ||
        ...
        if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible)l(a, function (a, b) {
            ...
            if (o && h > o) {
                ...
                if (qa(k)) {
                    ...
                    for (c = 0; c < h; c++)t[c] = n, w[c] = a[c], n += i;
                    e.xIncrement = n
                } else if (Ha(k))if (q)for (c = 0; c < h; c++)i = a[c], t[c] = i[0], w[c] = i.slice(1, q + 1); else for (c = 0; c < h; c++)i = a[c], t[c] = i[0], w[c] = i[1]; else ka(12)
            } else for (c = 0; c < h; c++)if (a[c] !== u && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c),
                n && i.name))m.names[i.x] = i.name;
            Da(w[0]) && ka(14, !0);
            e.data = [];
            e.options.data = a;
        ...
        if (k && this.sorted && (!i ||
            d > i || this.forceCrop))if (b[d - 1] < m || b[0] > n)b = [], c = []; else if (b[0] < m || b[d - 1] > n)e = this.cropData(this.xData, this.yData, m, n), b = e.xData, c = e.yData, e = e.start, f = !0;
        ...
        for (n = 0; n < g; n++)i = h + n, j ? m[n] = (new f).init(this, [d[n]].concat(ra(e[n]))) : (b[i] ? k = b[i] : a[i] !== u && (b[i] = k = (new f).init(this, a[i], d[n])), m[n] = k), m[n].index =
            i;
        ...
        d = a.length;
        for (m = 0; m < d; m++)if (j = c[m], k = a[m], i = k !== null && k !== u && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[m + 1] || j) >= g && (c[m - 1] || j) <= h, i && j)if (i = k.length)for (; i--;)k[i] !==
        ...
        for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || qa(i), k = a.threshold, m, n, o, t = Number.MAX_VALUE, a = 0; a < g; a++) {
            var l = f[a], r = l.x, D = l.y;
            n = l.low;
            var v = b && e.stacks[(this.negStacks && D < k ? "-" : "") + this.stackKey];
            if (e.isLog && D !==
                null && D <= 0)l.y = D = null, ka(10);
            l.plotX = m = c.translate(r, 0, 0, 0, 1, i, this.type === "flags");
            if (b && this.visible && v && v[r])v = v[r], D = v.points[this.index + "," + a], n = D[0], D = D[1], n === 0 && (n = p(k, e.min)), e.isLog && n <= 0 && (n = null), l.total = l.stackTotal = v.total, l.percentage = v.total && l.y / v.total * 100, l.stackY = D, v.setOffset(this.pointXOffset || 0, this.barW || 0);
        ...
        if (m.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, l = !!g.marker, a = s && o.enabled === u || o.enabled, w = g.isInside, a && e !== u && !isNaN(e) && g.y !== null)if (a = g.pointAttr[g.selected ?
            "select" : ""] || n, h = a.r, i = p(o.symbol, this.symbol), j = i.indexOf("url") === 0, k)k[w ? "show" : "hide"](!0).animate(r({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {})); else {
            if (w && (h > 0 || j))g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 * h, l ? o : m).attr(a).add(q)
        ...
        if (!j || g < j || m)for (; g--;) {
            ...
            if (w.length) {
                m = 0;
                for (f = w[m]; j[s] >= f.value;)f = w[++m];
                j.color = j.fillColor = f.color
            }
            m = b.colorByPoint || j.color;
            if (j.options)for (u in n)q(c[n[u]]) && (m = !0);
            if (m) {
                c = c || {};
                m = [];
                d = c.states || {};
                ...
                if (!b.marker)f.color = f.color || !j.options.color && e[j.negative && h ? "negativeColor" :
                    "color"] || oa(j.color).brighten(f.brightness || e.brightness).get();
                f = {color: j.color};
        ...
        ], d = b.lineWidth, e = b.linecap !==
            "square", f = this.getGraphPath(), g = this.fillGraph && this.color || L;
        l(this.zones, function (d, e) {
            c.push(["colorGraph" + e, d.color || a.color, d.dashStyle || b.dashStyle])
        });
        l(c, function (c, i) {
            var j = c[0], k = a[j];
            if (k)db(k), k.animate({d: f}); else if ((d || g) && f.length)k = {stroke: c[1], "stroke-width": d, fill: g, zIndex: 1}, c[2] ? k.dashstyle = c[2] : e && (k["stroke-linecap"] = k["stroke-linejoin"] = "round"), a[j] = a.chart.renderer.path(f).attr(k).add(a.group).shadow(!i && b.shadow)
        })
    }, applyZones: function () {
        var a = this, b = this.chart, c = b.renderer,
            d = this.zones, e, f, g = this.clips || [], h, i = this.graph, j = this.area, k = s(b.chartWidth, b.chartHeight), m = this[(this.zoneAxis || "y") + "Axis"], n = m.reversed, o = m.horiz;
        if (d.length && (i || j))i.hide(), j && j.hide(), l(d, function (d, i) {
            ...
            b.inverted && c.isVML && (h = m.isXAxis ? {x: 0, y: n ? e :
                f, height: h.width, width: b.chartWidth} : {x: h.y - b.plotLeft - b.spacingBox.x, y: 0, width: h.height, height: b.chartHeight});
        ...
        if (b.xAxis)O(c, "resize", a), O(b, "destroy", function () {
            X(c, "resize", a)
        }), a(), b.invertGroups = a
        ...
        c = a.options;
        var d = c.animation, d = d && !!a.animate && b.renderer.isSVG && p(d.duration, 500) || 0, e = a.visible ? "visible" : "hidden",
            f = c.zIndex, g = a.hasRendered, h = b.seriesGroup;
        ...
        d && a.animate();
        if (!g)d ? a.animationTimeout = setTimeout(function () {
                a.afterAnimate()
            },
            d) : a.afterAnimate();
    ...
    }, kdDimensions: 1, kdTree: null, kdAxisArray: ["plotX", "plotY"], kdComparer: "distX", searchPoint: function (a) {
        ...
        function b(a, h, i, j) {
            ...
            var l = q(a[f]) && q(k[f]) ? Math.pow(a[f] - k[f], 2) : null, p = (n || 0) + (l || 0);
            n = {distX: q(n) ? Math.sqrt(n) : Number.MAX_VALUE, distY: q(l) ? Math.sqrt(l) : Number.MAX_VALUE, distR: q(p) ? Math.sqrt(p) : Number.MAX_VALUE};
            k.dist = n;
            m = a[m] - k[m];
            n = m < 0 ? "left" : "right";
            h[n] && (n = b(a, h[n], i + 1, j), o = n.dist[d] < o.dist[d] ? n : k, k = m < 0 ? "right" : "left", h[k] && Math.sqrt(m * m) < o.dist[d] && (a = b(a, h[k], i + 1, j), o = a.dist[d] < o.dist[d] ? a : o));
            return o
        }

        var c = this, d = this.kdComparer,
            e = this.kdAxisArray[0], f = this.kdAxisArray[1];
    ...
    R.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            ...
            for (q = 0; q < d; q++) {
                ...
                l = (o = j && v < f) ? i : h;
                m[l] || (m[l] = {});
                if (!m[l][r])n[l] && n[l][r] ? (m[l][r] = n[l][r], m[l][r].total = null) : m[l][r] = new Fb(k, k.options.stackLabels, o, r, g);
                l = m[l][r];
                l.points[p] = [l.cum ||
                    0];
                e === "percent" ? (o = o ? h : i, j && m[o] && m[o][r] ? (o = m[o][r], l.total = o.total = s(o.total, l.total) + P(v) || 0) : l.total = da(l.total + (P(v) || 0))) : l.total = da(l.total + (v || 0));
                l.cum = (l.cum || 0) + (v || 0);
    ...
    r(A.prototype, {addSeries: function (a, b, c) {
        var d, e = this;
        ...
        new ua(this, z(a, {index: this[e].length, isX: b}));
        f[e] = ra(f[e] || {});
        f[e].push(a);
        p(c, !0) && this.redraw(d)
    }, showLoading: function (a) {
        var b = this, c = b.options, d = b.loadingDiv,
            e = c.loading, f = function () {
                d && I(d, {left: b.plotLeft + "px", top: b.plotTop + "px", width: b.plotWidth + "px", height: b.plotHeight + "px"})
            };
        if (!d)b.loadingDiv = d = Y(Ka, {className: "highcharts-loading"}, r(e.style, {zIndex: 10, display: L}), b.container), b.loadingSpan = Y("span", null, e.labelStyle, d), O(b, "redraw", f);
        b.loadingSpan.innerHTML = a || c.lang.loading;
        if (!b.loadingShown)I(d, {opacity: 0, display: ""}), kb(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
        f()
    ...
    r(R.prototype, {addPoint: function (a, b, c, d) {
        var e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart, j = this.xAxis && this.xAxis.names,
            k = g && g.shift || 0, m = e.data, n, o = this.xData;
        Sa(d, i);
        ...
        c && (f[0] && f[0].remove ? f[0].remove(!1) : (f.shift(), this.updateParallelArrays(d, "shift"), m.shift()));
        delete this.kdTree;
        ...
        a = z(e, {animation: !1, index: this.index, pointStart: this.xData[0]},
    ...
    r(ua.prototype, {update: function (a, b) {
    ...
    N.area = pa;
    aa.spline = z(Q);
    wa = ja(R, {type: "spline", getPointSpline: function (a, b, c) {
        var d =
            b.plotX, e = b.plotY, f = a[c - 1], g = a[c + 1], h, i, j, k;
        if (f && g) {
            a = f.plotY;
            j = g.plotX;
            var g = g.plotY, m;
            ...
            i += m;
            k += m;
            i > a && i > e ? (i = s(a, e), k = 2 * e - i) : i < a && i < e && (i = J(a, e), k = 2 * e - i);
            k > g && k > e ? (k = s(g, e), i = 2 * e - k) : k < g && k < e && (k = J(g, e), i = 2 * e - k);
            b.rightContX = j;
            b.rightContY = k
        }
    ...
    pa =
        pa.prototype;
    wa = ja(wa, {type: "areaspline", closedStacks: !0, getSegmentPath: pa.getSegmentPath, closeSegment: pa.closeSegment, drawGraph: pa.drawGraph, drawLegendSymbol: Na.drawRectangle});
    N.areaspline = wa;
    aa.column = z(Q, {borderColor: "#FFFFFF", borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: {hover: {brightness: 0.1, shadow: !1, halo: !1}, select: {color: "#C0C0C0", borderColor: "#000000", shadow: !1}}, dataLabels: {align: null, verticalAlign: null, y: null}, stickyTracking: !1,
        tooltip: {distance: 6}, threshold: 0});
    wa = ja(R, {type: "column", pointAttrToOptions: {stroke: "borderColor", fill: "color", r: "borderRadius"}, cropShoulder: 0, directTouch: !0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function () {
        ...
        var c = J(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, m = b.pointWidth, b = q(m) ? (k - m) / 2 : k * b.pointPadding, m = p(m, k - 2 * b);
        return a.columnMetrics = {width: m, offset: b + (j + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * k - c / 2) * (e ? -1 : 1)}
    }, translate: function () {
        var a = this,
            b = a.chart, c = a.options, d = a.borderWidth = p(c.borderWidth, a.closestPointRange * a.xAxis.transA < 2 ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = p(c.minPointLength, 5), h = a.getColumnMetrics(), i = h.width, j = a.barW = s(i, 1 + 2 * d), k = a.pointXOffset = h.offset, m = -(d % 2 ? 0.5 : 0), n = d % 2 ? 0.5 : 1;
        ...
        l(a.points, function (c) {
            ...
            u = s(h, d) - r;
            P(u) <
                g && g && (u = g, r = x(P(r - f) > g ? d - g : f - (e.translate(c.y, 0, 1, 0, 1) <= f ? g : 0)));
            c.barX = l;
            c.pointWidth = i;
            ...
            d && (r -= 1, u += 1);
            c.shapeType = "rect";
            c.shapeArgs = {x: l, y: r, width: q, height: u}
        })
        ...
        if (ba)a ? (e.scaleY = 0.001, a = J(b.pos + b.len, s(b.pos,
    ...
    N.column = wa;
    aa.bar = z(aa.column);
    pa = ja(wa, {type: "bar", inverted: !0});
    N.bar = pa;
    aa.scatter = z(Q, {lineWidth: 0, marker: {enabled: !0}, tooltip: {headerFormat: '<span style="color:{series.color}">●</span> <span style="font-size: 10px;"> {series.name}</span><br/>',
    ...
    Q = {type: "pie", isCartesian: !1, pointClass: ja(Ga, {init: function () {
        ...
        b.visible =
            b.options.visible = a = a === u ? !b.visible : a;
        ...
        for (n = 0; n < o; n++) {
            ...
            g = j + b * i;
            l.shapeType = "arc";
            l.shapeArgs = {x: a[0], y: a[1], r: a[2] / 2, innerR: a[3] / 2, start: x(f * 1E3) / 1E3, end: x(g * 1E3) / 1E3};
            h = (g + f) / 2;
            h > 1.5 * la ? h -= 2 * la : h < -la / 2 && (h += 2 * la);
            l.slicedTranslation = {translateX: x(W(h) * d), translateY: x(Z(h) * d)};
            f = W(h) * a[2] / 2;
            g = Z(h) * a[2] / 2;
            ...
            l.angle = h;
            e = J(e, m / 2);
            l.labelPos = [a[0] + f + W(h) * m, a[1] + g + Z(h) * m, a[0] + f + W(h) *
    ...
    }, searchPoint: na, sortByAngle: function (a, b) {
        a.sort(function (a, d) {
            return a.angle !== void 0 && (d.angle - a.angle) * b
        })
    }, drawLegendSymbol: Na.drawRectangle, getCenter: Vb.getCenter, getSymbol: na};
    Q = ja(R, Q);
    N.pie = Q;
    R.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions &&
            a.dlProcessOptions(d), j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({opacity: +h}), h || O(a, "afterAnimate", function () {
            a.visible && j.show();
            ...
            if (l && !h)e.dataLabel = l.destroy(); else if (h) {
                ...
                if (l)if (q(i))l.attr({text: i}), y = !1; else {
                    if (e.dataLabel = l = l.destroy(), x)e.connector = x.destroy()
                } else if (q(i)) {
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, x(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)))d = r({x: g ? f.plotWidth - i : h, y: x(g ? f.plotHeight - h : i), width: 0, height: 0}, d), r(c, {width: j.width,
    ...
    if (N.pie)N.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = p(e.connectorPadding, 10), g = p(e.connectorWidth, 1), h = d.plotWidth,
            i = d.plotHeight, j, k, m = p(e.softConnector, !0), n = e.distance, o = a.center, q = o[2] / 2, r = o[1], u = n > 0, y, v, z, C = [
                [],
                []
            ], B, A, F, I, E, G = [0, 0, 0, 0], N = function (a, b) {
                return b.y - a.y
            };
            ...
            for (I = 2; I--;) {
                ...
                if (M) {
                    ...
                    if (n > 0) {
                        ...
                        for (E =
                                 s(0, r - q - n); E <= v; E += b)K.push(E);
                        v = K.length;
                        if (M > v) {
                            c = [].concat(H);
                            c.sort(N);
                            for (E = M; E--;)c[E].rank = E;
                            for (E = M; E--;)H[E].rank >= v && H.splice(E, 1);
                            M = H.length
                        }
                        for (E = 0; E < M; E++) {
                            c = H[E];
                            ...
                            c = 9999;
                            var S, Q;
                            for (Q = 0; Q < v; Q++)S = P(K[Q] - z[1]), S < c && (c = S, L = Q);
                    ...
                    for (E = 0; E < M; E++) {
                        ...
                        y._pos = {x: B + e.x + ({left: f, right: -f}[z[6]] || 0), y: A + e.y - 10};
                        y.connX = B;
                        y.connY = A;
                        if (this.options.size === null)v = y.width, B - v < f ? G[3] = s(x(v - B + f), G[3]) : B + v > h - f && (G[1] = s(x(B + v - h + f), G[1])), A - b / 2 < 0 ? G[0] = s(x(-A + b / 2), G[0]) : A + b / 2 > i && (G[2] = s(x(A + b / 2 - i), G[2]))
                    }
                }
            }
        ...
        }, N.pie.prototype.alignDataLabel = na, N.pie.prototype.verifyDataLabelOverflow = function (a) {
        ...
        d[1] !== null ? e = s(J(e, b[2] - s(a[0], a[2])), c) : (e = s(J(e, b[2] - a[0] - a[2]), c), b[1] += (a[0] - a[2]) / 2);
    ...
    if (N.column)N.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (h && (d = z(h), f && (d = {x: g.yAxis.len - d.y - d.height, y: g.xAxis.len - d.x - d.width, width: d.height, height: d.width}), !j))f ? (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height :
            0, d.height = 0);
    ...
    Q = y.TrackerMixin = {drawTrackerPoint: function () {
        ...
        var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, m = k && {cursor: k}, k = a.singlePoints, n, o = function () {
        ...
        j ? j.attr({d: d}) : (a.tracker = h.path(d).attr({"stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: p, fill: c ? p : L, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2}).add(a.group), l([a.tracker, a.markerGroup], function (a) {
    ...
    if (N.column)wa.prototype.drawTracker = Q.drawTrackerPoint;
    ...
    r(A.prototype, {showResetZoom: function () {
        var a =
            this, b = S.lang, c = a.options.chart.resetZoomButton, d = c.theme, e = d.states, f = c.relativeTo === "chart" ? null : "plotBox";
        ...
        l(b === "xy" ? [1, 0] : [1], function (b) {
            var d = a[b ? "chartX" : "chartY"], h = c[b ? "xAxis" : "yAxis"][0], i = c[b ? "mouseDownX" :
                "mouseDownY"], j = (h.pointRange || 0) / 2, k = h.getExtremes(), m = h.toValue(i - d, !0) + j, j = h.toValue(i + c[b ? "plotWidth" : "plotHeight"] - d, !0) - j, i = i > d;
            if (h.series.length && (i || m > J(k.dataMin, k.min)) && (!i || j < s(k.dataMax, k.max)))h.setExtremes(m, j, !1, !1, {trigger: "pan"}), e = !0;
        ...
        onMouseOut: function () {
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && m.states && m.states[a] && m.states[a].enabled === !1)) {
                if (this.graphic)g = g && this.graphic.symbolName && p.r, this.graphic.attr(z(p, g ? {x: c - g, y: d - g, width: 2 * g, height: 2 * g} : {})), k && k.hide(); else {
                    if (a && i)if (g = i.radius, m = m.symbol || e.symbol, k && k.currentSymbol !== m && (k = k.destroy()), k)k[b ? "animate" : "attr"]({x: c -
                        g, y: d - g}); else if (m)e.stateMarkerGraphic = k = l.renderer.symbol(m, c - g, d - g, 2 * g, 2 * g).attr(p).add(e.markerGroup), k.currentSymbol = m;
                    if (k)k[a && l.isInsidePlot(c, d, l.inverted) ? "show" : "hide"]()
                }
                if ((c = f[a] && f[a].halo) && c.size) {
                    if (!o)e.halo = o = l.renderer.path().add(l.seriesGroup);
                    o.attr(r({fill: oa(this.color || e.color).setOpacity(c.opacity).get()}, c.attributes))[b ? "animate" : "attr"]({d: this.haloPath(c.size)})
                } else o && o.attr({d: []});
                this.state = a
            }
        }, haloPath: function (a) {
    ...
    r(R.prototype, {onMouseOver: function () {
        ...
        f = (c.visible =
            a = c.userOptions.visible = a === u ? !h : a) ? "show" : "hide";
    ...
    r(y, {Color: oa, Point: Ga, Tick: Ta, Renderer: $a, SVGElement: M, SVGRenderer: ta, arrayMin: Pa, arrayMax: Fa, charts: $, dateFormat: Oa, error: ka, format: Ja, pathAnim: yb, getOptions: function () {
        return S
    }, hasBidiBug: Lb, isTouchDevice: Hb, setOptions: function (a) {
        S = z(!0, S, a);
        Cb();
        return S
    }, addEvent: O, removeEvent: X, createElement: Y, discardElement: Ra, css: I, each: l, map: Ma, merge: z, splat: ra, extendClass: ja,
