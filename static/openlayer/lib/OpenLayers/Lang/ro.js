...
OpenLayers.Lang.ro = {
    ...
    // console message
    'minZoomLevelError': "Proprietatea minZoomLevel este doar pentru a fi folosită " +
    ...
    'googleWarning': "Stratul Google nu a putut fi încărcat corect.<br><br>" +
    ...
    'getLayerWarning': "Stratul ${layerType} nu a putut fi încărcat corect.<br><br>" +
    ...
    'Graticule': 'Graticule',
    // console message
    'reprojectDeprecated': "folosești opțiunea 'reproject' " +
